...
/**
 * Interface graphique du client de controle a distance.
 * Utilise la classe Client comme couche reseau sous-jacente.
 *
 * @author Koumba Samb
 */
public class ClientGUI extends JFrame {
    ...
    private void construireInterface() {
        ...
        // Zone centrale : resultats + historique
        ...
        JList<String> historiqueList = new JList<>(historiqueModel);
        JScrollPane scrollHist = new JScrollPane(historiqueList);
        ...
        // Navigation historique avec les fleches haut/bas
        ...
        // Clic sur l'historique : charge la commande dans le champ
        historiqueList.addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting() && !historiqueList.isSelectionEmpty()) {
                tfCommande.setText(historiqueList.getSelectedValue());
            }
    });
        }
    ...
    private void envoyerCommande() {
        ...
        afficher("\n> " + cmd + "\n");
        // Execution dans un thread separe (ne bloque pas l'interface)
        new Thread(() -> {
    ...
    /** Ajoute du texte dans la zone de resultats et fait defiler vers le bas. */
