...
/**
 * Interface graphique du serveur de controle a distance.
 * Affiche les clients connectes et le journal d'activite.
 *
 * @author Koumba Samb
 */
public class ServerGUI extends JFrame {
    ...
    /** Construit tous les composants graphiques. */
    private void construireInterface() {
        setLayout(new BorderLayout(8, 8));
        ((JComponent) getContentPane()).setBorder(
                BorderFactory.createEmptyBorder(10, 10, 10, 10));
        // Panneau de controle (haut)
        ...
        // Panneau central : clients + journal
        ...
        scrollClients.setBorder(
                BorderFactory.createTitledBorder("Clients connectes"));
        ...
        scrollLog.setBorder(
                BorderFactory.createTitledBorder("Journal d'activite"));
    ...
    /** Lance le serveur dans un thread dedie (hors EDT). */
     ...
     * @param message  Texte a afficher dans le journal
     */
